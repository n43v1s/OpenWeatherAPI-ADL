...
TestObject requestObj = findTestObject('Object Repository/Weather/Get_5DayForecast')
...
double forecastLat = jsonResponse.city.coord.lat
double forecastLon = jsonResponse.city.coord.lon
def tolerance = 0.001
